...
private:
	...
	bool inject_zenttric(LPVOID address_to_inject, DWORD size, HANDLE hProcess);
	bool inject_real_text_section(PVOID base_address, HANDLE hProcess);
